...
st.set_page_config(page_title="Nhận dạng đối tượng YOLOv8", page_icon="☑️")
page_bg_img = """
<style>
...
classes = None
with open('./model/object_detection_classes_yolov8.txt', 'rt') as f:
...
try:
      ...
      st.session_state["Net"] = cv2.dnn.readNet('./model/yolov8.weights', './model/yolov8.cfg')
